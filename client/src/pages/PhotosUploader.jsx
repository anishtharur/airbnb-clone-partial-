          ...
          addedPhotos.map((link) => (
            <div key={`${link}`} className="h-32 flex relative">
              ...
              <button
                ...
                className="absolute bottom-1 right-1 text-white bg-black bg-opacity-50 px-2 py-2 rounded-xl"
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-1  text-white bg-black bg-opacity-50 px-2 py-2 rounded-xl"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
